...
export default {
  data() {
    return {
      ...
      org: null,
      myheaders: [
        { text: "نوع الحالة", value: "statustype" },
        { text: "الحالة", value: "name" },
    ...
    modifyOrgs() {
      return this.status.map(org => {
        return {
          id: org.id,
          name: org.name,
          statustype: this.statusType.find(sec => sec.id === org.statusTypeId).value
        };
      });
    }
  },
